...
export default async function handler(req: any, res: any) {
  ...
  // 1b. Route Money Fusion Checkout (/api/moneyfusion/checkout)
  if (pathname.includes('/moneyfusion/checkout')) {
    const {
      amount = 1000,
      docId = '',
      userId = '',
  ...
  // 1c. Route Money Fusion Webhook (/api/webhooks/moneyfusion)
