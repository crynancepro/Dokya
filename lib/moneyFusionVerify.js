...
export async function verifyMoneyFusionWithOfficialApi(tokenOrTxId) {
  ...
  try {
    const url = `https://pay.moneyfusion.net/paiementNotif/${encodeURIComponent(cleanId)}`;
    ...
    console.error('[verifyMoneyFusionWithOfficialApi] Erreur:', err?.message);
  }
