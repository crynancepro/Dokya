...
export const DokyaSupportChat: React.FC<DokyaSupportChatProps> = ({
  ...
  return (
    <div className={`flex flex-col h-[750px] max-h-[85vh] bg-slate-950 border border-slate-800/90 rounded-3xl overflow-hidden shadow-2xl ${className}`}>
      
      {/* ========================================================================= */}
      {/* HEADER : WHATSAPP-INSPIRED TOP BAR WITH ESCALATION BUTTON                */}
      {/* ========================================================================= */}
      <div className="bg-slate-900 border-b border-slate-800 p-4 sm:px-6 flex flex-wrap items-center justify-between gap-3 shrink-0">
      ...
      {/* ========================================================================= */}
      <div 
        className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 relative bg-[#0b141a]/90"
        style={{
          backgroundImage: `radial-gradient(circle at 50% 50%, rgba(30, 41, 59, 0.2) 1px, transparent 1px)`,
      ...
      >
        {messages.map((msg) => {
          ...
          return (
            ...
            >
              <div
                className={`max-w-[85%] sm:max-w-[70%] rounded-2xl p-3 sm:p-3.5 shadow-md relative space-y-2 ${
                  isUser
              ...
              >
                ...
                <div className={`flex items-center gap-1 text-[10px] justify-end ${isUser ? 'text-emerald-200/80' : 'text-slate-400'}`}>
                  <span>
                    {msg.createdAt
        ...
        {isRecording ? (
          ...
          <form onSubmit={handleSendMessage} className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 py-3 px-4 rounded-2xl bg-slate-950 border border-slate-800 text-white text-xs sm:text-sm placeholder-slate-500 focus:outline-none focus:border-violet-500 transition-colors"
            />
            ...
            <button
              ...
              className="p-3 rounded-2xl bg-violet-600 hover:bg-violet-500 disabled:opacity-50 text-white shadow-lg shadow-violet-600/30 transition-all cursor-pointer active:scale-95 shrink-0"
