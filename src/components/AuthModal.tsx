      ...
      <div className="relative w-full max-w-md bg-neutral-900 border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-neutral-400">
            {mode === 'forgot_password'
              ? 'Saisissez votre e-mail pour recevoir le lien officiel de réinitialisation'
              : mode === 'login' 
        ...
        {/* Google Quick Login Button (hidden in forgot_password mode) */}
        {mode !== 'forgot_password' && (
          <>
            <button
              type="button"
        ...
        <div className="text-center pt-2 text-xs text-neutral-400">
          {mode === 'forgot_password' ? (
            <button
              ...
              className="text-violet-400 font-bold hover:underline cursor-pointer inline-flex items-center gap-1"
            >
